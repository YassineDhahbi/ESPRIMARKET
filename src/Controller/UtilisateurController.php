    ...
    public function login(Request $request, SessionInterface $session): Response
    {
        ...
        if ($user) {
            ...
            if ($user->getRole() === 'Admin') {
                return $this->redirectToRoute('app_publication'); // Redirection vers la page admin_page
            } elseif ($user->getRole() === 'Client') {
                return $this->redirectToRoute('front_publication'); // Redirection vers la page dons_page
            }
        } else {
